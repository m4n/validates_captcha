Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG.rdoc", "MIT-LICENSE", "README.rdoc", "Rakefile", "lib/validates_captcha", "lib/validates_captcha.rb", "lib/validates_captcha/controller_validation.rb", "lib/validates_captcha/form_builder.rb", "lib/validates_captcha/form_helper.rb", "lib/validates_captcha/image_generator", "lib/validates_captcha/image_generator/simple.rb", "lib/validates_captcha/model_validation.rb", "lib/validates_captcha/provider", "lib/validates_captcha/provider/image.rb", "lib/validates_captcha/provider/question.rb", "lib/validates_captcha/reversible_encrypter", "lib/validates_captcha/reversible_encrypter/simple.rb", "lib/validates_captcha/string_generator", "lib/validates_captcha/string_generator/simple.rb", "lib/validates_captcha/test_case.rb", "lib/validates_captcha/version.rb", "rails/init.rb", "test/cases", "test/cases/controller_validation_test.rb", "test/cases/image_generator", "test/cases/image_generator/simple_test.rb", "test/cases/model_validation_test.rb", "test/cases/provider", "test/cases/provider/image_test.rb", "test/cases/provider/question_test.rb", "test/cases/reversible_encrypter", "test/cases/reversible_encrypter/simple_test.rb", "test/cases/string_generator", "test/cases/string_generator/simple_test.rb", "test/cases/validates_captcha_test.rb", "test/test_helper.rb"]
